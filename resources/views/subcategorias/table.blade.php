        ...
        @foreach($subcategorias as $subcategorias)
            <tr>
                ...
                <td width="120">
                    ...
                    <div class='btn-group'>
                        <a href="{{ route('subcategorias.show', [$subcategorias->id]) }}" class='btn btn-default btn-xs'>
                            <i class="far fa-eye"></i>
                        </a>
                        <a href="{{ route('subcategorias.edit', [$subcategorias->id]) }}" class='btn btn-default btn-xs'>
