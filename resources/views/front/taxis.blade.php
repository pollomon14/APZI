...
<a href="{{ route('expresos', $municipio->id) }}">
    ...
    <h1 style="width: 94%;margin-left: 3%;color: #000c4f;font-size: 30px;font-family: 'ITC Avant Garde Gothic Std Medium';border-bottom: 2px solid #000c4f;line-height: 27px;margin-top: 5%;">Taxis</h1>
        ...
        <div class="container">
            <div class="row" style="width: 98%;margin-left: 1%;margin-right: 0;border: 1px solid #000c4f;border-radius: 4px;">
                <div class="col-md-6" style="width: 100%;">
                    <div class="row" style="background: #ffff00;border-top-right-radius: 4px;border-bottom: 1px solid #000c4f;border-left: 1px none #000c4f;border-top-left-radius: 4px;">
                        <div class="col" style="width: 100%;padding-right: 0;padding-left: 0;">
                            <h1 style="width: 90%;font-size: 14px;color: #000c4f;font-family: 'ITC Avant Garde Gothic Std Medium';line-height: 16px;margin-bottom: 0;text-align: center;margin-left: 5%;border-top-right-radius: 4px;"><br>{{$transp->placa}}<br><br></h1>
                        </div>
                    </div>
