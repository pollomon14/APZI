...
<a href="{{ route('carga', $municipio->id) }}">   
        <figure class="figure" style="width: 20%;margin-left: 2%;border-radius: 4px;border: 1px solid #000c4f;"><img class="img-fluid figure-img" style="width: 60%;margin-bottom: 40%;margin-top: 10%;" src="/assets/img/carga.svg?h=b94c0d9cf3d22fbeedc7e6577f7812e2">
            <figcaption class="figure-caption" style="width: 100%;margin-left: 0px;font-size: 11px;background: #000c4f;font-family: 'ITC Avant Garde Gothic Std Medium';font-weight: normal;border-radius: 0;border-bottom-right-radius: 4px;border-bottom-left-radius: 4px;color: #fff;border-style: none; text-transform:uppercase">Carga</figcaption>
        </figure>
</a>
<a href="{{ route('domiciliarios', $municipio->id) }}">
        <figure class="figure" style="width: 20%;margin-left: 2%;border-radius: 4px;border: 1px solid #000c4f;"><img class="img-fluid figure-img" style="width: 60%;margin-bottom: 40%;margin-top: 10%;" src="/assets/img/mensajeria.svg?h=83cf56c02d4376fdb121080cf3cb393a">
            <figcaption class="figure-caption" style="width: 100%;margin-left: 0px;font-size: 11px;background: #000c4f;font-family: 'ITC Avant Garde Gothic Std Medium';font-weight: normal;border-radius: 0;border-bottom-right-radius: 4px;border-bottom-left-radius: 4px;color: #fff;border-style: none; text-transform:uppercase">Mensajería</figcaption>
        </figure>
</a>
<a href="{{ route('expresos', $municipio->id) }}">
        <figure class="figure" style="width: 20%;margin-left: 2%;border-radius: 4px;border: 1px solid #000c4f;"><img class="img-fluid figure-img" style="width: 60%;margin-bottom: 40%;margin-top: 10%;" src="/assets/img/expreso.svg?h=631812cdefd91dd676358ff3380febc5">
            <figcaption class="figure-caption" style="width: 100%;margin-left: 0px;font-size: 11px;background: #000c4f;font-family: 'ITC Avant Garde Gothic Std Medium';font-weight: normal;border-radius: 0;border-bottom-right-radius: 4px;border-bottom-left-radius: 4px;color: #fff;border-style: none; text-transform:uppercase">Expresos</figcaption>
        </figure>
</a>
    </div>
    <h1 style="width: 94%;margin-left: 3%;color: #000c4f;font-size: 30px;font-family: 'ITC Avant Garde Gothic Std Medium';border-bottom: 2px solid #000c4f;line-height: 27px;margin-top: 5%; text-transform:uppercase">Taxis</h1>
    @foreach($transporte as $transp)
    @if(is_null($transp->id_icono) && is_null($transp->desplegable))
                ...
                <div class="col-md-6" style="width: 100%;">
                    <div class="row" style="background: #ffff00;border-top-right-radius: 4px;border-bottom: 1px solid #000c4f;border-left: 1px none #000c4f;border-top-left-radius: 4px;">
                        <div class="col" style="width: 100%;padding-right: 0;padding-left: 0;">
                            <h1 style="width: 90%;font-size: 14px;color: #000c4f;font-family: 'ITC Avant Garde Gothic Std Medium';line-height: 16px;margin-bottom: 0;text-align: center;margin-left: 5%; text-transform:uppercase"><br>{{$transp->placa}}<br><br></h1>
                        </div>
                    </div>
...
@elseif (is_null($transp->id_icono) && !is_null($transp->desplegable))
        <!-- Start: 1 Row 2 Columns -->
        <div style="text-align: center;margin-top: 5%;margin-bottom: 5%;">
        <div class="container">
            <div class="row" style="width: 98%;margin-left: 1%;margin-right: 0;border: 1px solid #000c4f;border-radius: 4px;">
                <div class="col-md-6" style="width: 100%;">
                    <div class="row" style="background: #ffff00;border-top-right-radius: 4px;border-bottom: 1px solid #000c4f;border-left: 1px none #000c4f;border-top-left-radius: 4px;">
                        <div class="col" style="width: 100%;padding-right: 0;padding-left: 0;">
                            <h1 style="width: 90%;font-size: 14px;color: #000c4f;font-family: 'ITC Avant Garde Gothic Std Medium';line-height: 16px;margin-bottom: 0;text-align: center;margin-left: 5%;border-top-right-radius: 4px; text-transform:uppercase;"><br>{{$transp->placa}}<br><br></h1>
                        </div>
                    </div>
    ...
    @endif
                ...
                <div class="col-md-6" style="width: 70%;">
                    <div class="row" style="border-bottom: 1px solid #000c4f;border-left: 1px solid #000c4f;background: #ffff00;border-top-right-radius: 4px;">
                        <div class="col" style="width: 100%;padding-right: 0;padding-left: 0;">
                            <h1 style="width: 90%;font-size: 14px;color: #000c4f;font-family: 'ITC Avant Garde Gothic Std Medium';line-height: 16px;margin-bottom: 0;text-align: center;margin-left: 5%; text-transform:uppercase">
