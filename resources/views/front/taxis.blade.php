...
<body style="border-radius: 24px;border-top-left-radius: 0px;border-style: none;border-top-width: 1px;border-right-width: 0px;border-right-style: none;border-bottom-width: 1px;border-bottom-style: none;border-left-width: 0px;border-bottom-right-radius: 10px;">
    <!-- Start: Collapsible sidebar left or right . Content overla -->
    <div style="border-style: none;height: 12%;background: #000c4f;">
        <!-- Start: overlay -->
        ...
        <div id="sidebar">
            ...
            <div class="sidebar-content-div"><a class="btn btn-primary w-100 sidebar-btn" role="button" href="#">Meer info</a><a class="btn btn-primary w-100 sidebar-btn" role="button" href="#">Contact</a><a class="btn btn-primary w-100 sidebar-btn" role="button" href="#">Meer info</a><a class="btn btn-primary w-100 sidebar-btn" role="button" href="#">Contact</a><a class="btn btn-primary w-100 sidebar-btn" role="button" href="#">Meer info</a><a class="btn btn-primary w-100 sidebar-btn" role="button" href="#">Contact</a><a class="btn btn-primary w-100 sidebar-btn" role="button" href="#">Meer info</a><a class="btn btn-primary w-100 sidebar-btn" role="button" href="#">Contact</a></div>
        </div>
        <div id="content" style="border-style: none;height: 12%;">
            <!-- Start: Informations -->
            ...
            <div class="row" style="width: 98%;margin-left: 1%;margin-right: 0;border: 1px solid #000c4f;border-radius: 4px;">
                <div class="col-md-6" style="width: 30%;padding-right: 0;padding-left: 0;">
                    <div class="row d-flex align-items-center" style="height: 70%;">
                        <div class="col"><img style="width: 80%;border-radius: 10px;" src="/assets/img/taxi.svg?h=dc70e5134e1fec6b23f5ebad63e052d3"></div>
                    </div>
                ...
                <div class="col-md-6" style="width: 70%;">
                    ...
                    <div class="row">
                        <div class="col" style="border-bottom: 1px solid #000c4f;border-left: 1px solid #000c4f;padding-right: 0;padding-left: 0;">
                            <h1 style="width: 100%;font-size: 14px;font-family: 'Montserrat Regular';color: #000c4f;font-weight: 400;margin-bottom: 5%;"><br>Camilo Torres</h1>
                        </div>
                    </div>
                    <div class="row" style="background: #f2f2f2;border-bottom-right-radius: 4px;">
                        ...
                        <div class="col" style="width: 50%;padding-left: 0;padding-right: 0;border-bottom-right-radius: 10px;"><i class="fa fa-angle-double-right" style="margin-right: 5%;color: #000c4f;"></i><i class="fa fa-whatsapp" style="color: #000c4f;font-weight: bold;"></i><i class="fa fa-angle-double-left" style="margin-left: 5%;color: #000c4f;"></i>
                            <h1 style="font-size: 14px;width: 100%;color: #000c4f;line-height: 6px;font-family: 'ITC Avant Garde Gothic Std Medium';"><br>314 448 3232<br><br></h1>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row" style="width: 98%;margin-left: 1%;margin-right: 0;border: 1px solid #000c4f;border-radius: 4px;">
                <div class="col-md-6" style="width: 100%;">
                    <div class="row" style="background: #ffff00;border-top-right-radius: 4px;border-bottom: 1px solid #000c4f;border-left: 1px none #000c4f;border-top-left-radius: 4px;">
                        <div class="col" style="width: 100%;padding-right: 0;padding-left: 0;">
                            <h1 style="width: 90%;font-size: 14px;color: #000c4f;font-family: 'ITC Avant Garde Gothic Std Medium';line-height: 16px;margin-bottom: 0;text-align: center;margin-left: 5%;border-top-right-radius: 4px;"><br>CENTRAL ASORADIO<br><br></h1>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col" style="background: #000c4f;font-size: 14px;color: #fff;padding-right: 0;padding-left: 0;border-bottom-right-radius: 4px;border-bottom-left-radius: 4px;border-left: 1px none #000c4f;">
                            <!-- Start: Mega Menu Dropdown 100% Editable - Ambrodu -->
                            <div class="dropdown megamenu" style="width: 100%;"><button class="btn btn-primary dropdown-toggle" aria-expanded="false" data-toggle="dropdown" type="button" style="width: 100%;margin-right: 0;margin-bottom: 0;margin-left: 0;padding-right: 0;background: #000c4f;font-family: 'Montserrat Regular';border-bottom-right-radius: 4px;border-bottom-left-radius: 4px;border-top-left-radius: 0px;border-top-right-radius: 0px;border-style: none;border-bottom-style: none;border-bottom-color: #ffff00;">Ver Más Números&nbsp;</button>
                                    ...
                                    <div class="container" style="padding-bottom: 0;">
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <hr style="background-color: #ffffff;">
                                                <h5 class="text-white" style="font-size: 14px;line-height: 14px;font-family: 'ITC Avant Garde Gothic Std Medium';"><i class="fa fa-phone" style="margin-right: 5%;margin-left: 5%;"></i>031 866 1791 Cuadrante I</h5>
                                                <hr style="background-color: #ffffff;">
