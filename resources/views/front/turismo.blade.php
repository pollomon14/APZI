...
@section('content')
    ...
    <h1 style="width: 94%;margin-left: 3%;color: #000c4f;font-size: 30px;font-family: 'ITC Avant Garde Gothic Std Medium';border-bottom: 2px solid #000c4f;line-height: 27px;padding-top: 30%; ">Sitios Turísticos</h1><!-- Start: Bootstrap 4 - Photo Gallery --><div class="photo-gallery" style="padding-top:0" >
  ...
  <div class="px-lg-5">
    ...
    <div class="row">
      ...
      <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <div class="bg-white rounded shadow-sm" style="border:1px solid #000c4f !important;margin-bottom: 0; border-radius: 4px !important;"><h5 style=" margin-bottom: 0;background-color:#ffff00; border-radius: 4px 4px 0px 0px !important; border-bottom: 1px solid #000c4f; text-align:center; padding-bottom: 1%;"> <a href="{{route('local',[$dir->id,$municipio->id])}}" class="text-dark" style="color:#000c4f !important;  font-size: 16px !important;font-family: 'ITC Avant Garde Gothic Std Demi'; text-transform: uppercase;">{{$dir->nombre}}</a></h5><a href="{{route('local',[$dir->id,$municipio->id])}}"><img src="https://drive.google.com/uc?id={{ $dir->imagen1 }}" alt="" class="img-fluid card-img-top" style="border-radius: 4px !important; width:94%!important; margin:3% !important; border:1px solid #000c4f;"></a>
        <div class="row" >
    ...
    @endif
        ...
        <div class="p-4" style="padding: 0rem!important;">
             ...
             <div class="d-flex align-items-center justify-content-between rounded-pill px-3 py-2 mt-4" style="justify-content: flex-end !important; border-radius: 0px 0px 4px 4px !important; margin-top:2% !important; background-color:#000c4f">
              <p class="small mb-0"><span class="font-weight-bold" style="color:white; font-family: 'Montserrat Regular'; text-align:right; text-transform: uppercase;">Ver Más Información&nbsp;&nbsp;&nbsp;</span></p>
