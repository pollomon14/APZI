    ...
    <div class="carousel slide" data-ride="carousel" id="carousel-1" style="border-style: none;padding-top: 20%;">
        <div class="carousel-inner">
            <div class="carousel-item active"><img class="w-100 d-block"
                ...
                <h1
                    style="width: 100%;color: #000c4f;background: #ffff00;text-align: center;font-size: 16px;font-family: 'ITC Avant Garde Gothic Std Demi';font-weight: normal;margin-bottom: 0;padding-top: 1%;padding-bottom: 1%;border: 1px solid #ffff00 ;">
                    <i class="fa fa-whatsapp" style="font-weight: bold;"></i>&nbsp; Ir a whatsapp
                </h1>
            </div>
            ...
            <div class="carousel-item"><img class="w-100 d-block"
                    src="/assets/img/IMAGEN3.png?h=5f06cb82cf49df28880ea16b787febc7" alt="Slide Image">
                <h1
                    style="width: 100%;color: #000c4f;background: #f2f2f2;text-align: center;font-size: 16px;font-family: 'ITC Avant Garde Gothic Std Demi';font-weight: normal;margin-bottom: 0;padding-top: 1%;padding-bottom: 1%;border-width: 1px;border-style: solid;">
                    <i class="fa fa-whatsapp" style="font-weight: bold;"></i>&nbsp; Ir a whatsapp
                </h1>
            </div>
        </div>
        ...
        <ol class="carousel-indicators"
            style="width: 90%;min-height: 0px;margin-right: 0;margin-left: 5%;margin-bottom: 8%;">
